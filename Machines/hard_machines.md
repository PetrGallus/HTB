...
Freelance starts with gaining access as an employer and then continues with elevation of privileges to the administrator account via the IDOR vulnerability. I'll obtained a shell as a SQL user using standard MSSQL commands. I then switched to another user, performed a memory dump, and gained access to a third user. An unintentional way was later discovered to exploit resource-based restricted delegation, ultimately leading to domain administrator access.

### Reco

#### nmap

`sudo nmap -sVC -O -A -oA 10.10.11.5_freelancer 10.10.11.5 -v`

```bash
Starting Nmap 7.93 ( https://nmap.org ) at 2024-06-07 13:44 CEST
...
Completed Ping Scan at 13:44, 0.08s elapsed (1 total hosts)
Initiating SYN Stealth Scan at 13:44
Scanning freelancer.htb (10.10.11.5) [1000 ports]
...
Completed SYN Stealth Scan at 13:44, 0.90s elapsed (1000 total ports)
Initiating Service scan at 13:44
Scanning 11 services on freelancer.htb (10.10.11.5)
Completed Service scan at 13:44, 8.85s elapsed (11 services on 1 host)
Initiating OS detection (try #1) against freelancer.htb (10.10.11.5)
Retrying OS detection (try #2) against freelancer.htb (10.10.11.5)
Retrying OS detection (try #3) against freelancer.htb (10.10.11.5)
Retrying OS detection (try #4) against freelancer.htb (10.10.11.5)
Retrying OS detection (try #5) against freelancer.htb (10.10.11.5)
Initiating Traceroute at 13:44
Completed Traceroute at 13:44, 0.06s elapsed
Initiating Parallel DNS resolution of 1 host. at 13:44
Completed Parallel DNS resolution of 1 host. at 13:44, 0.04s elapsed
NSE: Script scanning 10.10.11.5.
Initiating NSE at 13:44
Completed NSE at 13:44, 8.55s elapsed
Initiating NSE at 13:44
Completed NSE at 13:44, 1.44s elapsed
Initiating NSE at 13:44
Completed NSE at 13:44, 0.00s elapsed
...
88/tcp   open  kerberos-sec  Microsoft Windows Kerberos (server time: 2024-06-07 15:44:18Z)
...
TCP/IP fingerprint:
OS:SCAN(V=7.93%E=4%D=6/7%OT=53%CT=1%CU=30686%PV=Y%DS=2%DC=T%G=Y%TM=6662F2AA
OS:%P=x86_64-pc-linux-gnu)SEQ(SP=107%GCD=1%ISR=10C%TI=I%CI=I%II=I%SS=S%TS=U
...
HOP RTT      ADDRESS
1   50.49 ms 10.10.14.1
2   51.09 ms freelancer.htb (10.10.11.5)
...
Nmap done: 1 IP address (1 host up) scanned in 31.32 seconds
           Raw packets sent: 1094 (51.682KB) | Rcvd: 1091 (46.906KB)
```

* Obtained info:
  * Win machine
  * Kerberos
  * AD LDAP (freelancer.htb -> add to /etc/hosts)
  * MS Win RPC over HTTP 1.0
  * SMBv2
  * traceroute without any redirect

SMB

`sudo smbclient -L 10.10.11.5`
...
do_connect: Connection to 10.10.11.5 failed (Error NT_STATUS_RESOURCE_NAME_NOT_FOUND)
Unable to connect with SMB1 -- no workgroup available
```

* cant access it anonymouslym
